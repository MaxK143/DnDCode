...
public class DiceStats {
	...
	private static int SampleSizeOne = 1000000000 ;
	private static int SampleSizeTwo = 11 ; // Total Sample size is One.tpow(Two) an can be greater than Integer.MaxInt

	public static void main(String[] args) {
		
		StartTime = System.currentTimeMillis() ;
		
		double[][] Method = RunStats( SampleSizeOne , SampleSizeTwo ) ;
		
		double[] AverageStats = Method[0] ;
		
		double[] Occurances = Method[1] ;
		
		double[] AverageOccurances = Method[2] ;
		
		double[] OneOccurances = Method[3] ;
		
		System.out.print( "Run Time: " + ( System.currentTimeMillis() - StartTime ) + " MilliSeconds" ) ;
		
		System.out.println( "Total Sample Size: " + SampleSizeOne + " to the power of " + SampleSizeTwo ) ;
